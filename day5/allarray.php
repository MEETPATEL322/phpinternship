...
$a = array("meet","Sahil","prit","Keyur","Amitji","Ajay");
shuffle($a);
foreach ($a as $key => $value){
    echo "<b><br/> $value</b>";
}
...
$a = array("A" => "meet", "S" => "Sahil","B" => "prit","K" => "Keyur");
...
echo "<br/><b>----------------------Flip----------------------</b><br/>";
$a = array ("A" => "meet","S" => "Sahil", "K" => "Keyur", "B" => "prit");
$b = array_flip($a);
print_r($b);
...
$a=array("meet","Sahil","prit","Keyur","Amitji","Ajay","C","java","php");
$b=array("meet","Sahil","java","php");
$c = array_diff($a, $b);
print_r($c);

echo "<br/><b>----------------------Intersect----------------------</b><br/>";
$a = array(0=>"meet",1=>"Sahil",2=>"prit",3=>"Amitji",4=>"Keyur");
$b = array(5=>"Sahil",6=>"meet",7=>"Friends");
...
$a = array("meet","Sahil","Both","are","Brothers","Enemy");
array_pop($a); 
print_r($a);
array_pop($a); 
print_r($a);
...
$a = array("meet","love","PHP","language");
$b = implode(" ", $a);
echo $b;
